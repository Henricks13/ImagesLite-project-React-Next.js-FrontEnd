      ...
      <section className="flex flex-col items-center justify-center my-5">
        ...
        <form onSubmit={formik.handleSubmit} action="">
            ...
            <label className=" block text-sm font-medium leading-6 text-gray-600">Image: *</label>
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-10">
                <div className="text-center">
                  ...
                  <div className="p-5 flex text-sm leading-6 text-gray-600">
          ...
          <div className="mt-5 flex items-center justify-end gap-x-4">
            <Button type="submit" label="Save" style="bg-blue-500 hover:bg-blue-300" />
            <Link href="/galeria">
              <Button type="button" label="Cancel" style="bg-red-500 hover:bg-red-300" />
            </Link>
          </div>
        </form>
      </section>
